...
CREATE INDEX idx_teams_total_time ON teams(total_time ASC NULLS LAST);
CREATE INDEX idx_teams_current_round ON teams(current_round DESC);
...
CREATE INDEX idx_ip_log_team ON ip_log(team_id);
